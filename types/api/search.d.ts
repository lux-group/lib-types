...
export declare type SearchResult = Array<{
    id: string;
    kind: string;
    packages?: string[];
}>;
...
export declare type SearchLeByPlaceResult = Array<{
...
export declare type SearchBedbankByPlaceResult = string[];
...
export declare type SearchByPropertyResult = SearchResult;
export declare type SearchByPropertyResponseBody = ListOffersResponseBody;
...
export declare type SearchByMapAreaResult = SearchResult;
export declare type SearchByMapAreaResponseBody = ListOffersResponseBody;
export {};
